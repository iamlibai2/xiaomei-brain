...
def main() -> None:
    ...
    if len(sys.argv) < 2:
        print("Usage:")
        print("  xiaomei-brain start <agent_id> [--no-consciousness] [--legacy]")
        print("  xiaomei-brain run <agent_id> [--cli] [--no-consciousness] [--legacy] [--port <port>]")
        print("  xiaomei-brain stop <agent_id> [--force]")
        print("  xiaomei-brain restart <agent_id>")
        print("  xiaomei-brain status <agent_id>")
        print("  xiaomei-brain tui [--host <host>] [--port <port>]")
        print("  xiaomei-brain agent <list|info|create|delete> ...")
        print("  xiaomei-brain config <get|set|validate|file> ...")
        print("  xiaomei-brain plugins <list|enable|disable> ...")
        print("  xiaomei-brain logs <agent_id> [-f] [-n <lines>]")
        print("  xiaomei-brain doctor [--fix] [-v]")
        sys.exit(1)
