"""Shared curses-based UI components for xiaomei-brain CLI.

Ported from Hermes (hermes_cli/curses_ui.py).
Provides curses multi-select and single-select with keyboard navigation,
plus text-based numbered fallbacks for terminals without curses support.
"""
...
# Sentinel: an on_action reducer returns this to mean "keep looping"
_KEEP = object()
