...
# 用途: 梦境对方记忆提取 — 从当天对话提取关于对方的信息
DREAM_USER_EXTRACT_PROMPT = """你是一个记忆提取器。从以下对话记录中，提取关于**对方**的值得长期记住的信息。

提取规则：
- 只提取关于对方的信息：对方的事实、偏好、重要决定、个人经历
- 不要提取关于AI助手自身的信息
- 用第三人称"对方"来描述，明确信息主体是对方
- 忽略寒暄、情绪表达、无实质内容的对话
- 每条记忆用以下格式输出：
  ADD: 记忆内容（以"对方"开头） | scenes: 场景1,场景2
