    ...
    class Handler(BaseHTTPRequestHandler):
        ...
        def do_GET(self) -> None:  # noqa: N802
            if self.path.rstrip("/") == "/health":
                send_json(self, 200, health_payload(model="bge-small-zh-v1.5", device=selected, dim=dimension))
            else:
        ...
        def do_POST(self) -> None:  # noqa: N802
            ...
            try:
                ...
                if isinstance(texts_value, list):
                    ...
                    on_inference()
                    send_json(self, 200, {"vectors": vectors.tolist(), "model": "bge-small-zh-v1.5", "dim": dimension})
                else:
                    ...
                    on_inference()
                    send_json(self, 200, {"vector": vector.tolist(), "model": "bge-small-zh-v1.5", "dim": dimension})
