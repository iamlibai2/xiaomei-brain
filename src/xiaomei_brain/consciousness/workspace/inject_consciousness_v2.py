...
_SECTION_REGISTRY: list[tuple[str, object, object]] = [
    ("header",      _render_header,              _score_always),
    ("being",       _render_being,               _score_being),
    ("essence",     _render_essence,             _score_essence),
    ("body",        _render_body,                _score_body),
    ("trajectory",  _render_self_trajectory,     _score_trajectory),
    ("mind",        _render_mind,                _score_mind),
    ("inner_voice", _render_inner_voice,         _score_inner_voice),
    ("memory",      _render_memory,              _score_memory),
    ("milestones",  _render_milestones,          _score_milestones),
    ("pace",        _render_pace_reflections,    _score_pace),
    ("experience",  _render_experience,          _score_experience),
    ("project_map", _render_project_map,         _score_project_map),
    ("intent",      _render_intent,              _score_intent),
    ("desk",        _render_desk,                _score_desk),
    ("environment", _render_environment,         _score_environment),
    ("history",     _render_history,             _score_history),
    ("timeline",    _render_experience_timeline, _score_timeline),
]
