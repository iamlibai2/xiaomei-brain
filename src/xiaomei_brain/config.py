...
class Config:
    ...
    tts_api_key: str = ""
    tts_base_url: str = "https://api-bj.minimaxi.com"
    ...
    music_api_key: str = ""
    music_base_url: str = "https://api.minimaxi.com"
    ...
    image_api_key: str = ""
    image_base_url: str = "https://api.minimaxi.com"
    ...
    def from_json(cls, config_path: str | Path | None = None) -> Config:
        ...
        if tts_data:
            ...
            kwargs["tts_base_url"] = tts_data.get("base_url", "https://api-bj.minimaxi.com")
        ...
        if music_data:
            ...
            kwargs["music_base_url"] = music_data.get("base_url", "https://api.minimaxi.com")
        ...
        if image_data:
            ...
            kwargs["image_base_url"] = image_data.get("base_url", "https://api.minimaxi.com")
