...
from .scroll_sensor import ScrollSensor
from .touchpad_sensor import TouchpadSensor
...
class Touch(Sense):
    ...
    def __init__(self):
        super().__init__()
        self._touchpad: TouchpadSensor | None = None
    ...
    def set_touchpad(self, device: TouchpadSensor) -> None:
