...
def register(ctx):
    # ProviderProfile is mutable because per-Agent configuration can override
    # its endpoint and model catalog. Always create a fresh instance so
    # registries in the same process cannot affect each other.
