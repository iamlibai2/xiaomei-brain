"""BaiduSearchProvider — 百度 AI 搜索（千帆）实现。"""
...
from xiaomei_brain.tools.provider.websearch import WebSearchProvider, SearchResult
...
class BaiduSearchProvider(WebSearchProvider):
    ...
    provider_id: str = "baidu"
    display_name: str = "百度搜索"
    priority: int = 0  # 内置保底，插件 provider 可设更高覆盖
