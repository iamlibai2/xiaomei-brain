...
**Type**:
- Cover title: ultra-heavy condensed poster type, 88–120 pt when supported; use an installed display font available to the PPTX writer and fall back safely when unavailable. It may rotate slightly and cross the canvas edge when the writer supports that layout.
- Page titles: 42–58 pt, may be reversed white on a black ground.
- Body text: 14–17 pt, in a clear sans-serif or serif face.
- Annotations: 10–12 pt monospaced when an installed font is available, mimicking typewriter labels.
...
**Type**:
- Masthead: ultra-heavy sans-serif, 72–100 pt when supported, using an installed display font available to the PPTX writer; use all caps where appropriate or otherwise set as ultra-bold short text.
- Headlines: 44–72 pt, tight leading.
- Body text: 11–14 pt serif, line spacing 1.25–1.4.
- Data and labels: 10–14 pt monospaced when an installed font is available.
